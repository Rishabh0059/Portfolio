    ...
    <div name="Home" className="h-screen text-white w-full bg-gradient-to-b from-black via-black to-gray-800">
      <div className="flex flex-col md:flex-row max-w-screen-lg mx-auto px-4 items-center h-full">
        <div className="flex flex-col justify-center h-full">
          ...
          <div>
            <button className="group text-white w-fit px-6 py-3 my-2 flex items-center rounded-md bg-gradient-to-r from-cyan-500 to-blue-500 cursor-pointer"><a href="https://drive.google.com/file/d/1OSzYXkgLUAbmT0zfKgVQHRou7ZYjYwRq/view?usp=sharing" target="_blank" rel="noopner noreferrer">Resume</a>
