...
const Navbar = () => {
  ...
  return (
    <div className="flex justify-between md:fixed items-center bg-black w-full h-16 px-4 text-white z-50">
      <div>
      <h1 className="text-4xl ml-2 font-signature">Rishabh</h1>
      </div>
      ...
      {nav && (
        <ul className="flex flex-col justify-center w-full absolute top-0 bottom-0 h-screen bg-gradient-to-b from-black to-gray-800 z-50">
